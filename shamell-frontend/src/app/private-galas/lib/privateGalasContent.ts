import { Crown, Flame, Sparkles, Theater } from "lucide-react";

import type { ServicePageContent } from "../types/privateGalas.types";

export const privateGalasContent: ServicePageContent = {
  title: "Private Galas",
