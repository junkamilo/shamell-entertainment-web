import { Clapperboard, Globe, Handshake, Palette } from "lucide-react";

import type { ServicePageContent } from "../types/bespokeCollaborations.types";

export const bespokeCollaborationsContent: ServicePageContent = {
  title: "Bespoke Collaborations",
  tagline: "Timeless ceremonial artistry",
  description:
    "For those seeking something truly one-of-a-kind. Shamell collaborates with artists, brands, event designers, and creative directors to craft bespoke performances that push boundaries and tell a story through movement.",
  features: [
    {
      icon: Handshake,
