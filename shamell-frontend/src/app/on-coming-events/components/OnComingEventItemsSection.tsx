...
function OnComingEventItemCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-4 px-4 py-4 md:px-5 md:py-4">
        <div
          className={cn(
        ...
        <div className="min-w-0 flex-1">
          <p className="font-body text-sm font-medium leading-snug text-foreground/92 md:text-base">
            {item}
          </p>
...
export function OnComingEventItemsSection({ items }: Props) {
  ...
  return (
    <RevealOnView className="mt-10" delay={30}>
      <section aria-labelledby="on-coming-event-items-heading">
