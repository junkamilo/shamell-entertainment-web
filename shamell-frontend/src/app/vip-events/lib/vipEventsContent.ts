import { ClipboardList, Gem, Landmark, Music } from "lucide-react";

import type { ServicePageContent } from "../types/vipEvents.types";

export const vipEventsContent: ServicePageContent = {
  title: "VIP Events",
  tagline: "Grace in motion",
  description:
    "Bring sophistication and spectacle to your VIP event. Whether it's a corporate gala, product launch, charity fundraiser, or exclusive gathering, Shamell delivers world-class belly dance that commands attention and elevates the atmosphere.",
  features: [
    {
      icon: Landmark,
