...
import {
  ...
  type LegendPlacedSummary,
} from "../lib/legendCountsFromPalette";

export type VenueSceneLegendProps = {
...
}: VenueSceneLegendProps) {
  const { large, medium, small, chairs } = legendCountsFromPalette(
    palette,
    placedSummary,
  );
