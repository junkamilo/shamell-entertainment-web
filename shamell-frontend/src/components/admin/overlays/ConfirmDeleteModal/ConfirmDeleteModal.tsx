...
export type ConfirmDeleteMessageProps = {
 ...
 * Prefer this over inline {@link ConfirmDeleteHighlight} for long titles.
 */
export function ConfirmDeleteMessage({
  ...
  const { display, full, truncated } = buildConfirmDeleteLabel(name, maxNameLength);
...
export function ConfirmDeleteHighlight({ children }: { children: ReactNode }) {
  return (
 ...
 * Wrap message in {@link ConfirmDeleteHighlight} for the entity name when needed.
 */
export function ConfirmDeleteModal({
  ...
  return (
    <Modal title={title} isOpen={isOpen} onClose={onClose} size="narrow">
