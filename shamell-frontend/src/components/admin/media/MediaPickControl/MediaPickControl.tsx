...
import { MediaUploadIconButton } from "../MediaUploadIconButton/MediaUploadIconButton";



export type MediaPickControlProps = {
...
export const MediaPickControl = forwardRef<HTMLInputElement, MediaPickControlProps>(

  function MediaPickControl(
