import { isValidInquiryCode } from "@/lib/contacto/contactInquiryConstants";
import {
  formatDateDisplayUs,
  formatTimeDisplayUs,
} from "@/lib/contacto/contactLogisticsUtils";
import { readableInquiryCode } from "../../lib/inquiry/inquiryCodeUtils";
  ...
  return (
    <div className="space-y-4 font-body text-base leading-relaxed text-foreground/90 sm:text-lg">
      ...
      <p className="text-sm leading-relaxed text-foreground/55 sm:text-base">
        Use the step tabs above to edit any section, or Back below. Your selection preview is below
        the form.
      </p>
    </div>
  );
