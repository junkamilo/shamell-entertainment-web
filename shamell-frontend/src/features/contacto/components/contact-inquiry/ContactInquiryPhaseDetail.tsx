...
import { isBespoke } from "../../lib/inquiry/inquiryCodeUtils";
    ...
    <div className="space-y-5">
      ...
      {(selectedLine?.occasionSingle.length ?? 0) === 0 ? (
        <p className="text-sm text-foreground/75 font-body">
          Optional: add any occasion notes for our team if your catalog line does not list a specific
          occasion type.
        </p>
      ) : null}
        ...
        <div>
          <label className="block">
            <span className="font-brand text-gold text-sm tracking-[0.14em]">
              Timeline / deadline notes{" "}
              <span className="text-foreground/40 font-body">(optional here)</span>
            </span>
            <textarea
