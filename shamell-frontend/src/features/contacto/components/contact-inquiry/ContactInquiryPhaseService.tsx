...
export default function ContactInquiryPhaseService(props: ContactInquiryPhaseProps) {
  ...
  const { data, contactLines, selectContactLine, setDetailModal } = props;
  return (
    <div className="space-y-4">
      <p className="font-body text-lg leading-relaxed text-foreground/80 md:text-xl md:leading-relaxed">
        Which catalog offering best matches what you are planning? Tap the eye to read the full
        description, inclusions, and guide investment.
      </p>
