    ...
    >
      ...
      {!sidebarCollapsed ? (
        <span className="flex min-w-0 items-center gap-2">
          ...
          {showBadge ? <NavNotification count={reservationsBadgeCount} /> : null}
        </span>
      ) : showBadge ? (
        <NavNotification count={reservationsBadgeCount} collapsed />
      ) : null}
    </Link>
  );
}
    ...
    <div ref={rootRef} className="flex flex-col gap-0.5">
      ...
      >
        ...
        <span className="flex min-w-0 flex-1 items-center gap-2 text-left">
          ...
          {reservationsBadgeCount > 0 ? (
            <NavNotification count={reservationsBadgeCount} />
          ) : null}
        </span>
        {expanded ? (
