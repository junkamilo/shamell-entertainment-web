import { Modal, MODAL_LAYERS } from "@/components/admin/overlays";
...
import { UpcomingClassSessionsPanel } from "@/features/admin/on-coming-events/components/UpcomingClassSessionsPanel";
  ...
  return (
    <>
      <ShamellBusyOverlay
        ...
        overlayZClass={MODAL_LAYERS.busy}
      />
      <Modal
        title={
          freeEventNameMode
