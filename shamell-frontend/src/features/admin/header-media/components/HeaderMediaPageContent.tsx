...
import { MediaPreviewModal, useMediaPreview } from "@/components/admin/media";
import { ConfirmDeleteModal } from "@/components/admin/overlays";
...
export default function HeaderMediaPageContent({ state }: Props) {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl">
      <BackButton href="/admin" label="Back" className="mb-4" />
