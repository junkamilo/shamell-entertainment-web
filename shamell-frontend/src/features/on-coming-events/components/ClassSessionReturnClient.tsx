...
import { pollCheckoutStatus } from "@/lib/stripe/checkoutReturnPolling";
import {
...
function ClassSessionReturnInner() {
...
export function ClassSessionReturnClient() {
  return (
    <Suspense
      fallback={
        <>
    ...
    >
      <ClassSessionReturnInner />
    </Suspense>
  );
}

export default ClassSessionReturnClient;
