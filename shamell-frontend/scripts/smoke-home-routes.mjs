/**
 * Smoke test: home must not 404; unknown paths must return 404.
 * Usage: npm run build && npm run start (in another terminal), then npm run smoke:home
 * Override base: SMOKE_BASE_URL=http://localhost:3010 node scripts/smoke-home-routes.mjs
 */
...
const cases = [
  ...
  },
  {
    ...
    path: "/__smoke-not-found",
    expectStatus: (s) => s === 404,
  },
];
...
console.log("\nAll home-route smoke tests passed.");
