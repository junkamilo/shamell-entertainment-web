...
export type ContactHttpAppOptions = {
  guardsAllow: boolean;
  contactService: Partial<ContactService> | object;
};

export async function createContactHttpApp(
  options: ContactHttpAppOptions,
): Promise<{
    ...
    providers: [
      {
        ...
        useValue: options.contactService,
      },
    ],
  })
