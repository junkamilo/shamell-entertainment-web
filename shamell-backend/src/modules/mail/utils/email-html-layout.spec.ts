import { buildAdminPaymentOutcomeHtml } from '../templates/admin-payment.mail';
import {
  buildBookingQuoteHtml,
  buildBookingBalanceLinkHtml,
} from '../../bookings/mail/booking-quote.mail';
import {
...
import { buildVenueReservationPaymentRequestHtml } from '../../venue-reservations/mail/venue-reservation-payment-request.mail';
