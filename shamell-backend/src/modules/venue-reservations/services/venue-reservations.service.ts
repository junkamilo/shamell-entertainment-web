...
} from '../utils/resolve-canonical-reservation-event-date.util';
...
} from '../mail/venue-reservation-confirmation.mail';
import { buildVenueReservationConfirmationPdf } from '../utils/venue-reservation-confirmation-pdf.util';
import {
  signConfirmationShareToken,
  verifyConfirmationShareToken,
} from '../utils/venue-reservation-confirmation-share.util';
import {
  buildVenueReservationPaymentRequestHtml,
  buildVenueReservationPaymentRequestSubject,
  buildVenueReservationPaymentRequestText,
} from '../mail/venue-reservation-payment-request.mail';
import {
  resolveVenueSeatDisplayLabel,
  toShortSeatDisplayLabel,
} from '../utils/venue-seat-display-label.util';
...
export class VenueReservationsService {
  ...
  constructor(
    private readonly repository: VenueReservationsRepository,
