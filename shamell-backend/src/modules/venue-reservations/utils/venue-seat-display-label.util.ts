...
import type { ResolveVenueSeatDisplayLabelArgs } from '../types/venue-reservations.types';

export type { ResolveVenueSeatDisplayLabelArgs } from '../types/venue-reservations.types';
