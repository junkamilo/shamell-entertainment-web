...
import type { VenueReservationConfirmationTemplateInput } from '../types/venue-reservations.types';

export type { VenueReservationConfirmationTemplateInput } from '../types/venue-reservations.types';
