-- Recurring class sections per weekday, session linkage, and package checkout.

CREATE TABLE "reservation_event_class_sections" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "reservation_event_class_sections_templateId_weekday_sortOrder_key"
    ON "reservation_event_class_sections"("templateId", "weekday", "sortOrder");
CREATE INDEX "reservation_event_class_sections_templateId_weekday_idx"
...
CREATE TABLE "upcoming_class_package_enrollments" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "upcoming_class_package_enrollments_stripeCheckoutSessionId_key"
    ON "upcoming_class_package_enrollments"("stripeCheckoutSessionId");
CREATE INDEX "upcoming_class_package_enrollments_eventId_status_idx"
...
CREATE TABLE "upcoming_class_package_enrollment_items" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "upcoming_class_package_enrollment_items_enrollmentId_key"
    ON "upcoming_class_package_enrollment_items"("enrollmentId");
CREATE INDEX "upcoming_class_package_enrollment_items_packageEnrollmentId_idx"
...
-- Backfill one section per active weekday from legacy recurring times.
